 ...
 * В приведенном коде используется оператор assert.
 * Этот оператор используется для того, чтобы проверять определенные инварианты в коде.
